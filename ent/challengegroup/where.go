...
func ID(id int) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.FieldEQ(FieldID, id))
}
...
func IDNEQ(id int) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.FieldNEQ(FieldID, id))
}

// IDIn applies the In predicate on the ID field.
func IDIn(ids ...int) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.FieldIn(FieldID, ids...))
}

// IDNotIn applies the NotIn predicate on the ID field.
func IDNotIn(ids ...int) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.FieldNotIn(FieldID, ids...))
}

// IDGT applies the GT predicate on the ID field.
func IDGT(id int) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.FieldGT(FieldID, id))
}

// IDGTE applies the GTE predicate on the ID field.
func IDGTE(id int) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.FieldGTE(FieldID, id))
}

// IDLT applies the LT predicate on the ID field.
func IDLT(id int) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.FieldLT(FieldID, id))
}
...
func And(predicates ...predicate.ChallengeGroup) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.ChallengeGroup) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.ChallengeGroup) predicate.ChallengeGroup {
	return predicate.ChallengeGroup(sql.NotPredicates(p))
}
