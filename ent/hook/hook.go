...
// The ChallengeGroupFunc type is an adapter to allow the use of ordinary
// function as ChallengeGroup mutator.
type ChallengeGroupFunc func(context.Context, *ent.ChallengeGroupMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ChallengeGroupFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ChallengeGroupMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ChallengeGroupMutation", m)
}
...
// The EpisodeRoundFunc type is an adapter to allow the use of ordinary
// function as EpisodeRound mutator.
type EpisodeRoundFunc func(context.Context, *ent.EpisodeRoundMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f EpisodeRoundFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.EpisodeRoundMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.EpisodeRoundMutation", m)
}
